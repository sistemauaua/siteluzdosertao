...
const schedule = [
    // --- SEGUNDA A SEXTA ---
    { days: [1, 2, 3, 4, 5], start: "05:00:00", end: "06:00:00", program: "RAIANDO O DIA", host: "Leidiano", photo: "assets/_Leidiano.png", timeRange: "05:00 ÀS 06:00" },
    ...
    { days: [1, 2, 3, 4, 5], start: "15:00:00", end: "17:00:00", program: "PROGRAMA TARDE DE SUCESSOS", host: "Tiago Moreno", photo: "assets/Tiago_Moreno.png", timeRange: "15:00 ÀS 17:00" },
    { days: [1, 2, 3, 4, 5], start: "17:00:00", end: "19:00:00", program: "PROGRAMA ISSO É SERTÃO", host: "Chico Mocó", photo: "assets/Chico_Mocó.png", timeRange: "17:00 ÀS 19:00" },
    ...
    { days: [1, 2, 3, 4, 5], start: "20:00:00", end: "22:00:00", program: "A VOZ DO COOPERATIVISMO", host: "COOPERCUC", photo: "assets/Hilário_Ortega.png", timeRange: "20:00 ÀS 22:00" },
    ...
    { days: [6], start: "17:00:00", end: "19:00:00", program: "UAUÁ, BAHIA, BRASIL, PANDEIRO", host: "Pedro Peixinho", photo: "assets/Pedro_Peixinho.png", timeRange: "17:00 ÀS 19:00" },
    ...
    { days: [6], start: "21:00:00", end: "23:00:00", program: "PROGRAMA NOITE DE SUCESSOS", host: "Hilário Ortega", photo: "assets/Hilário_Ortega.png", timeRange: "21:00 ÀS 23:00" },
    ...
    { days: [0], start: "16:00:00", end: "19:00:00", program: "PROGRAMA ROCK-REGGAE MUSICAL", host: "Hilário Ortega", photo: "assets/Hilário_Ortega.png", timeRange: "16:00 ÀS 19:00" },
    { days: [0], start: "19:00:00", end: "21:30:00", program: "RÁDIO LUZ DO SERTÃO", host: "Rádio Luz do Sertão", photo: "assets/Luz_do_Sertao.png", timeRange: "19:00 ÀS 21:30" },
...
// Audio Context
let isPlaying = false;
let audio = new Audio("http://stm1.uauhost.com.br:7506/stream"); 
audio.volume = 0.8; // Default volume
audio.autoplay = true; // Força tentativa nativa do navegador
...
function updateCurrentProgram() {
    ...
    let activeProgram = schedule.find(item => {
        return item.days.includes(currentDay) && currentTimeString >= item.start && currentTimeString < item.end;
    });
    ...
    if (currentShowEl.innerText !== activeProgram.program) {
        ...
        timeRangeEl.innerText = activeProgram.timeRange;
