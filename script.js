...
const schedule = [
    ...
    { days: [0], start: "16:00:00", end: "19:00:00", program: "PROGRAMA ROCK-REGGAE MUSICAL", host: "Hilário Ortega", photo: "assets/Hilario_Ortega.png", timeRange: "16:00 ÀS 19:00" },
...
audio.addEventListener('error', (e) => {
    ...
    // Se falhar o http, tentar sem o /stream ou com outro protocolo se necessário
});
...
function updateCurrentProgram() {
    ...
    if (currentShowEl && currentShowEl.innerText !== activeProgram.program) {
